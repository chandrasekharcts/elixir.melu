    ...
    function F(a) {
        ...
        return function (a) {
            ...
            if (!this.inline) {
                ...
                c && c.replaceWith(c.getFirst({
                    img: 1,
                    a: 1
                }))
            }
            d && "none" != d && (c = CKEDITOR.tools.parseCssText(g.style ||
                ""), "center" == d && "figure" == a.name ? a = a.wrapWith(new CKEDITOR.htmlParser.element("div", b ? {
                "class": b[1]
            } : {
                    ...
                    link: function (b, c, d) {
                        if (b.changed.link) {
                            var e = b.element.is("img") ? b.element : b.element.findOne("img"),
                                ...
                                i;
                            h && b.deflate();
                            d ? (c || (i = f.createElement("a", {
                                attributes: {
                                    href: b.newData.link.url
                                }
                            }), i.replace(e), e.move(i)), d = CKEDITOR.plugins.link.getLinkAttributes(a, d), CKEDITOR.tools.isEmpty(d.set) || (i || g).setAttributes(d.set), d.removed.length && (i || g).removeAttributes(d.removed)) : (d = g.findOne("img"), d.replace(g), i = d);
                            h && (b.element = i)
                        }
                    }
                };
